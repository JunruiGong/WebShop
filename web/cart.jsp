    ...
    <script type="text/javascript">
        function deleteProductFromCart(pid) {
            if (confirm("Delete it?")) {
                location.href = "${pageContext.request.contextPath}/product?method=deleteProductFromCart&pid=" + pid;
                ...
                <table class="table table-bordered">
                    ...
                    <c:forEach items="${cart.cartItems}" var="entry">
                        ...
                        <tr class="active">
                            ...
                            <td width="30%">
                                <a target="#">${entry.value.product.pname}</a>
                            </td>
                            <td width="20%">
...
<c:if test="${empty cart.cartItems}">
     <div>
         <
         <img src="${pageContext.request.contextPath}/images/cart-empty.png"></img>
