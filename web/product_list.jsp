...
<div class="row" style="width: 1210px; margin: 0 auto;">
    ...
    <c:forEach items="${pageBean.list}" var="product">
        ...
        <div class="col-md-2" style="height:250px">
            ...
            <p>
                <font color="#FF0000">商城价：&yen;${product.shop_price}0</font>
            </p>
        </div>
...
<div style="width: 380px; margin: 0 auto; margin-top: 50px;">
    <ul class="pagination" style="text-align: center; margin-top: 10px;">
        ...
        <c:if test="${pageBean.currentPage!=1}">
            <li>
                <a href="${pageContext.request.contextPath}/product?method=productListByCid&currentPage=${pageBean.currentPage-1}&cid=${cid}"
                   aria-label="Previous">
                    <span aria-hidden="true">&laquo;</span>
                </a>
            </li>
        ...
        <ul style="list-style: none;">
            <c:forEach items="${historyProductList}" var="historyProduct">
                <li style="width: 150px; height: 216px; float: left; margin: 0 8px 0 0; padding: 0 18px 15px; text-align: center;">
                    <a href="${pageContext.request.contextPath}/product?method=productInfo&pid=${historyProduct.pid}&cid=${cid}&currentPage=${pageBean.currentPage}"><img src="${pageContext.request.contextPath}/${historyProduct.pimage}" width="130px" height="130px"/></a>
                </li>
            </c:forEach>
