...
<head>
    ...
    <script type="text/javascript">
        function addCart() {
            ...
            location.href = "${pageContext.request.contextPath}/product?method=addProductToCart&pid=${product.pid}&quantity="+quantity;
        }
    </script>
</head>
        ...
        <div style="margin: 0 auto; width: 950px;">
            ...
            <div class="col-md-6">
                ...
                <div
                    ...
                    <div>
                        <a href="${pageContext.request.contextPath}/product?method=productListByCid&currentPage=${currentPage}&cid=${cid}">返回</a>
                    </div>
                </div>
            </div>
        </div>
